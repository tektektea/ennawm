<template>
    <div class="bg-white grid md:grid-cols-5 h-screen w-screen dark:bg-gray-900">
            ...
            <div class="flex items-center w-full  px-6 mx-auto lg:w-4/6">
                <div class="flex-1">
                    <div class="text-center">
                        <h2 @click="goHome" class="cursor-pointer text-4xl font-bold text-center text-accent dark:text-white">ENNAWM</h2>
                    ...
                    <div class="mt-8">
                        <q-form @submit="submit">
                            ...
                            <q-btn class="full-width mt-6" :href="route('home')" flat color="accent" label="Back to home"/>
        ...
        <div class="relative bg-primary flex justify-center items-center col-span-5 md:col-span-3">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="80%" height="80%"
                ...
                <path
                    ...
                    transform="translate(-203.5 -174.13424)" fill="#f9a826"/>
                <path
